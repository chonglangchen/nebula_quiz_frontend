<template>
  <view class="mine-page">
    ...
    <view class="mine__hero">
      ...
      <view class="mine__profile">
        ...
        <view class="mine__info">
          ...
          <text class="mine__meta">{{ user?.department || '' }} / {{ user?.employeeId || '' }}</text>
        </view>
      </view>
    ...
    <view class="mine__menu">
      ...
      <view v-if="user?.role === 'ADMIN'" class="mine__menu-item" hover-class="mine__menu-item--hover" @tap="handleAdmin">
